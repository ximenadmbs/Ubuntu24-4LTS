...
echo -e "\e[0;38;5;208m[Se iniciara la instalacion de paquetes, librerias, herramientas]\e[0m"
echo -e "\e[0;38;5;208m[y componetes de sistem.                                            ]\e[0m"
	             echo "-----------------------------------------------------------------" ; sleep 2s
	echo " "
#Seccion de Instalacion de paquetes librerias herramientas de personalisacion:
    ...
    #sudo nala install libfuse2t64 -y
    #echo -e "\e[0;38;5;208m█ libfuse2t64 installed \e[0m" ; sleep 1s
